...
/**
 * file AttributedConfigurationNode.java
 * author liumapp
...
public interface AttributedConfigurationNode extends ConfigurationNode {
    ...
    @Nullable
    @Override AttributedConfigurationNode getParent();
    @NonNull
    @Override List<? extends AttributedConfigurationNode> getChildrenList();
    @NonNull
    @Override Map<Object, ? extends AttributedConfigurationNode> getChildrenMap();
    @NonNull
    @Override AttributedConfigurationNode setValue(@Nullable Object value);
    @NonNull
    @Override AttributedConfigurationNode mergeValuesFrom(@NonNull ConfigurationNode other);
    @NonNull
    @Override AttributedConfigurationNode getAppendedNode();
    @NonNull
    @Override AttributedConfigurationNode getNode(@NonNull Object... path);
    @NonNull
    @Override AttributedConfigurationNode copy();
}
